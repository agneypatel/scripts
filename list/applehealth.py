# Python Script for visualising Apple Health Data
# Requirement : Health Data (export.xml), applehealth.py
# Source : https://www.agneypatel.com/blog
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        print('Correct usage: python /PATH/applehealthdata.py /PATH/export.xml',
              file=sys.stderr)
        sys.exit(1)
